...
from flowjax import bijections, distributions
from flowjax.flows import MaskedAutoregressiveFlow
from flowjax.train.variational_fit import elbo_loss, fit_to_variational_target
...
def test_fit_to_variational_target_e2e():
    ...
    jax.tree_util.tree_map(
        lambda trained_param, initial_param: not jnp.allclose(
            trained_param, initial_param
        ),
        trained_params,
        initial_params,
    )
